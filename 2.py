...
#напишем декоратор для some_func и wrapper для переброса аргументов
# и самой функции
def cls_method_decorator(param: int):
    def decorator(func): #модифицируем some_func
        def wrapper(self, *args, **kwargs):#обращаемся к инстансу класса
